...
const char ssids[] PROGMEM = {
    ...
    "Starbucks Wi-Fi\n"
    "Text 777-9846 for the Password\n"
    "Yell ____ for Password\n"
    "Yell for Password\n"
    "The Password Is 1234\n"
    "Un-Free Non-Public Wi-Fi\n"
    "No Free Wi-Fi Here\n"
...
{
    for (int i = 0; i < 6; i++)
        macAddr[i] = random(1, 256);
}

void wifi_spam_setup()
{
    // create empty SSID
    for (int i = 0; i < 32; i++)
    {
...
void wifi_spam_loop()
{
    ...
    if (currentTime - attackTime > 100)
    {
        ...
        while (i < ssidsLen)
        {
            ...
            {
                uint16_t tmpPacketSize = (109 - 32) + ssidLen + 1;       // calc size
